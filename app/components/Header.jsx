  ...
  return (
    <>
      ...
      <header className="fixed left-0 right-0 top-0 z-50 px-4 pt-4">
        <nav className="mx-auto flex h-[64px] sm:h-[78px] max-w-6xl flex-row-reverse items-center justify-between rounded-full border border-white/60 bg-white/55 px-3 sm:px-4 md:px-7 shadow-[0_8px_28px_rgba(15,23,42,0.10)] sm:shadow-[0_12px_42px_rgba(15,23,42,0.14)] backdrop-blur-md dark:border-white/10 dark:bg-white/10">
          {" "}
          ...
          <div className="flex items-center gap-2 md:gap-3">
            ...
            >
              <button
                ...
                className="flex h-11 cursor-pointer items-center gap-2 rounded-full border border-purple-500/30 bg-white/35 px-4 text-sm font-bold text-purple-700 backdrop-blur-sm transition hover:bg-purple-500/10 md:h-12 md:px-6 dark:border-purple-500/40 dark:bg-white/5 dark:text-purple-300 dark:hover:bg-purple-500/15"
              >
                <Info size={18} />
              ...
              <div
                className={`absolute right-0 top-[58px] w-[300px] rounded-3xl border border-[var(--surface-border)] bg-white/100 p-5 text-right shadow-[0_14px_42px_rgba(124,58,237,0.16)] backdrop-blur-md transition-all duration-300 dark:border-purple-500/20 dark:bg-[#070b1d]/100 ${
                  aboutOpen
            ...
            <button
              onClick={toggleTheme}
              className="flex h-11 w-11 cursor-pointer items-center justify-center rounded-full border border-[var(--surface-border)] bg-[var(--surface-card)] text-slate-800 backdrop-blur-sm transition hover:border-purple-400 hover:bg-white/70 md:h-12 md:w-12 dark:border-white/10 dark:bg-white/5 dark:text-slate-200 dark:hover:border-purple-400/50 dark:hover:bg-purple-500/10"
